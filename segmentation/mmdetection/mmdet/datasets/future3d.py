...
class Future3Dataset(CustomDataset):

    CLASSES = ('Children Cabinet', 'Nightstand', 'Bookcase / jewelry Armoire', 'Wardrobe', 
            'Tea Table', 'Corner/Side Table', 'Sideboard / Side Cabinet / Console', 'Wine Cooler', 
            'TV Stand', 'Drawer Chest / Corner cabinet', 'Shelf', 'Round End Table', 'Double Bed', 
            'Bunk Bed', 'Bed Frame', 'Single bed', 'Kids Bed', 'Dining Chair', 'Lounge Chair / Book-chair / Computer Chair', 
            'Dressing Chair', 'Classic Chinese Chair', 'Barstool', 'Dressing Table', 'Dining Table', 'Desk', 
            'Three-Seat / Multi-person sofa', 'armchair', 'Two-seat Sofa', 'L-shaped Sofa', 'Lazy Sofa', 'Chaise Longue Sofa', 
